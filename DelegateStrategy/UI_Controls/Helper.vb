...
Public Class Helper
    ...
    Sub New(p_validator As IDeepTools.Validator(Of SystemComponent, ResponseValidation))
        Validator = p_validator
    End Sub
    Private Property Validator As IDeepTools.Validator(Of SystemComponent, ResponseValidation) Implements IHelper.Validator
