...
Namespace WinFormMediator
    Public Class Mediator
        ...
        Sub New()
            ...
            MediatorWinForm_Recorder = New MediatorWinForm_Recorder(Me)
        End Sub
        ...
        Public Property MediatorWinForm_Recorder As IMediatorWinForm_Recorder Implements IMediator.MediatorWinForm_Recorder
